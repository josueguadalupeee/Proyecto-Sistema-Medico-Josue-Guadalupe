...
DATABASES = {
    "default": {
        ...
        'NAME': os.environ.get("DB_NAME", "db_medico"),
        'USER': os.environ.get("DB_USER", "postgres"),
        'PASSWORD': os.environ.get("DB_PASSWORD", "Josueguadalupe2003"),
...
EMAIL_HOST = os.getenv('EMAIL_HOST', 'smtp.gmail.com')  # Servidor SMTP de Gmail
EMAIL_PORT = int(os.getenv('EMAIL_PORT', 587))          # Puerto SMTP
EMAIL_USE_TLS = os.getenv('EMAIL_USE_TLS', 'True') == 'True'  # Seguridad TLS
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER')          # Dirección de correo
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD')  # Contraseña del correo o contraseña de aplicación
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER)  # Correo del remitente

LOGIN_URL = '/signin/'
LOGIN_REDIRECT_URL = '/home/'  # O cualquier otra página después del login.
