...
class TipoSangre(models.Model):
    tipo = models.CharField(
        ...
        unique=True,
        validators=[validate_blood_type]  # Aquí se aplica el validador
    )
...
class Paciente(models.Model):
    ...
    cedula = models.CharField(max_length=10, verbose_name="Cédula",validators=[valida_cedula],unique=True)
    ...
    latitud = models.DecimalField(max_digits=18, decimal_places=10, verbose_name="Latitud", null=True, blank=True,validators=[validar_latitud])
    # Longitud de la ubicación del paciente (coordenada geográfica)
    longitud = models.DecimalField(max_digits=18, decimal_places=10, verbose_name="Longitud", null=True, blank=True,validators=[validar_longitud])
    # Historia clínica
...
class Especialidad(models.Model):
    ...
    nombre = models.CharField(max_length=100, verbose_name="Nombre de la Especialidad",blank=False,unique=True)
...
class Doctor(models.Model):
    ...
    # Latitud de la ubicación del paciente (coordenada geográfica)
    latitud = models.DecimalField(max_digits=18, decimal_places=6, verbose_name="Latitud", null=True, blank=True,validators=[validar_latitud])
    # Longitud de la ubicación del paciente (coordenada geográfica)
    longitud = models.DecimalField(max_digits=18, decimal_places=6, verbose_name="Longitud", null=True, blank=True,validators=[validar_longitud])
    ...
    curriculum = models.FileField(upload_to='curriculums/', verbose_name="Curriculum", null=True, blank=True)
